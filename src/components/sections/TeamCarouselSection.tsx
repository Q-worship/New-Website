          ...
          >
            {teamCards.map((card) => (
              <div
                key={card.title}
                tabIndex={0}
                className="team-carousel-card w-[70vw] sm:w-[70vw] lg:w-[44vw] xl:w-[32vw] max-w-[560px] flex-shrink-0 group cursor-default focus-visible:ring-2 focus-visible:ring-blue-400/60 focus-visible:outline-none"
              >
